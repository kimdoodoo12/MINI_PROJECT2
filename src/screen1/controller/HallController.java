...
public class HallController {
    ...
    public static HallController getInstance(){return instance;}
...
//     ThreadPoolExecutor agentPool = (ThreadPoolExecutor) Executors.newFixedThreadPool(3);
...
//           System.out.println("\n==[현황] 고객 " + customerId + "번 인입 , [대기 상담원]: " + idleAgents + "명 , [통화
